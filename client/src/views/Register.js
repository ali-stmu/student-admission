...
console.log(emailValue)
  ...
  const illustration = skin === 'dark' ? 'register-v2-dark.svg' : 'register.jpg',
      ...
      <Row className='auth-inner m-0'>
        ...
        <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            ...
            <CardText className='mb-2'>Registering for the admission portal opens the door to a world of endless possibilities.!</CardText>
          ...
          onChange={(event) => { setEmail(event.target.value); handleEmailChange(event) } } placeholder='john@example.com'  />
...
*/}
              <Button.Ripple color='primary' block onClick={handleSubmit}  disabled={isButtonDisabled}>
